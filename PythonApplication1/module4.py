...
for i in range(10):
    testSet = mnist.test.next_batch(6000)
    xdat=sess.run(accuracy,feed_dict={ x: testSet[0], y_: testSet[1], keep_prob: 1.0})
    print("test accuracy %g"%(xdat))
